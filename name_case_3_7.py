guest_list = ['гермиона грейнджерс', 'северус снег', 'профессор дамблдор', 'гарри поттер']
# print(guest_list)
...
print(guest_list)
print("К сожаению я смогу привезти на свой званый ужин только двух гостей!")
print(f"{guest_list[0]}, вы не можете приехать ко мне на званый ужин")
del guest_list[0]
print(guest_list)
del guest_list[0]
print(guest_list)